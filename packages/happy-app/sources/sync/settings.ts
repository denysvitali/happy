...
export const SettingsSchema = z.object({
    ...
    // Recently used custom model IDs for quick selection
    recentModels: z.array(z.string()).default([]).describe('Recently used custom model IDs for quick selection'),
});
...
export const settingsDefaults: Settings = {
    ...
    // Recently used custom models (empty by default)
    recentModels: [],
};
